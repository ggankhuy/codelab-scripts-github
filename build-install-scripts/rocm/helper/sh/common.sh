...
case "$OS_NAME" in
   "Ubuntu")
        ...
        SHELL=bash
        apt-get update -y
        for i in cmake python3-pip sqlite3 libsqlite3-dev libbz2-dev nlohmann-json-dev half libboost-all-dev python-msgpack pybind11-dev numactl libudev1 libudev-dev chrpath pciutils pciutils-dev libdw libdw-dev 
        do  
            echo "Installing $i...."
