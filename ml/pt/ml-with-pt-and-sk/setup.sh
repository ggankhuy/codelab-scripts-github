...
"yum update -y" \
do
    echo "------------------------------" | tee $LOG_FOLDER/setup.generic.$counter.log
    echo "DBG: executing '$i'..." | tee -a $LOG_FOLDER/setup.generic.$counter.log
    echo "------------------------------"  | tee -a $LOG_FOLDER/setup.generic.$counter.log
...
do
    echo "------------------------------" | tee $LOG_FOLDER/setup.yum.$counter.log
    echo "DBG: executing '$i'..." | tee -a $LOG_FOLDER/setup.yum.$counter.log
    echo "------------------------------"  | tee -a $LOG_FOLDER/setup.yum.$counter.log
...
do
    echo "------------------------------" | tee $LOG_FOLDER/setup.pip3.$counter.log
    echo "DBG: executing '$i'..." | tee -a $LOG_FOLDER/setup.pip3.$counter.log
    echo "------------------------------"  | tee -a $LOG_FOLDER/setup.pip3.$counter.log
