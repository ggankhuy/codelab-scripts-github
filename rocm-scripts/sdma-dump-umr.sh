...
#        $PATH_UMR --pci 0000:$gpu_addr -O no_follow_ib -RS sdma$sdma | tee $LOG_FOLDER_BASE/umr.gpu-$gpu$i.sdma-$sdma.log
#        $PATH_UMR --pci 0000:$gpu_addr -O no_follow_ib -RS sdma$sdma[.] | tee $LOG_FOLDER_BASE/umr.gpu-$gpu$i.sdma-$sdma.log
        $PATH_UMR --pci 0000:$gpu_addr -O follow -RS sdma$sdma[:] | tee $LOG_FOLDER_BASE/umr.gpu-$gpu$i.sdma-$sdma.log
